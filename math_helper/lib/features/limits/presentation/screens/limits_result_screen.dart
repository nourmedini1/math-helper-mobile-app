...
class LimitsResultScreen extends StatefulWidget {
  final Operation operation;
  const LimitsResultScreen({super.key, required this.operation});

  @override
  State<LimitsResultScreen> createState() => _LimitsResultScreenState();
}

class _LimitsResultScreenState extends State<LimitsResultScreen> {
  @override
  ...
  Widget successWidget(
      BuildContext context, String title, String limit, String result) {
