...
class MatrixMultiplicationSuccessScreen extends StatelessWidget {
  final String matrixA;
  final String matrixB;
  final String resultMatrix;
  const MatrixMultiplicationSuccessScreen({
    super.key,
  ...
  void handleResetButtonPressed(BuildContext context) {
        context.read<MultiplyMatrixBloc>().add(const MultiplyMatrixReset());
    }
