...
class InvertMatrixResultScreen extends StatefulWidget {
  final Operation operation;
  const InvertMatrixResultScreen({super.key, required this.operation});

  @override
  State<InvertMatrixResultScreen> createState() =>
      _InvertMatrixResultScreenState();
}

class _InvertMatrixResultScreenState extends State<InvertMatrixResultScreen> {
  @override
          ...
          Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    matrixResult(context, result, "The matrix inverse", matrix),
                    const SizedBox(
                      height: 20,
                    )
                  ],
