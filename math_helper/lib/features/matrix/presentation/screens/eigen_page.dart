...
class EigenPage extends StatefulWidget {
  const EigenPage({super.key});

  @override
  State<EigenPage> createState() => _EigenPageState();
}

class _EigenPageState extends State<EigenPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: eigenScreen(context),
      ),
    );
  }

  Widget eigenScreen(BuildContext context) {
      ...
      child: BlocConsumer<EigenBloc, EigenState>(
        ...
        builder: (context, state) {
          if (state is EigenInitial) {
            return eigenInitialWidget(context);
            ...
            return successWidget(
                ...
                state.response.eigenValue!,
                state.response.eigenVector!);
  ...
  Widget eigenInitialWidget(BuildContext context) {
  ...
  Widget successWidget(BuildContext context, String title, String matrix,
      String eigenValue, String eigenVector) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      child: Column(
        children: [
          ...
          Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    matrixResult(context, matrix, "The Eigen Value and Vector",
      ...
      children: [
        ...
        Padding(
            ...
            child: TeXView(
                ...
                child: teXViewWidget(
                    context, "result", r"""$$""" + eigenVector + r"""$$"""))),
      ],
    );
  }
        ...
        child: GestureDetector(
          onTap: isFieldsReady
              ? () {
                  ...
                  BlocProvider.of<EigenBloc>(context)
                      .add(EigenRequested(request: request));
                }
              : () {},
          child: Container(
            width: double.infinity,
  ...
  Widget matrixResetButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
        BlocProvider.of<EigenBloc>(context).add(const EigenReset());
      },
