...
class DeterminantResultScreen extends StatefulWidget {
  final Operation operation;
  const DeterminantResultScreen({super.key, required this.operation});

  @override
  State<DeterminantResultScreen> createState() =>
      _DeterminantResultScreenState();
}

class _DeterminantResultScreenState extends State<DeterminantResultScreen> {
  @override
