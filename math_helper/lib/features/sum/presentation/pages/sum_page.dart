...
import 'package:math_helper/features/sum/presentation/widgets/numeric/numeric_sum_screen.dart';
import 'package:math_helper/features/sum/presentation/widgets/symbolic/symbolic_sum_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(controller: tabController, children: [
        Center(child: SymbolicSumScreen(
