...
class IntegralSuccessWidget extends StatelessWidget {
  final String title;
  final String integral;
  final String result;

  const IntegralSuccessWidget({
    super.key,
    required this.title,
...
class _IntegralResult extends StatelessWidget {
  final String integral;
  final String result;

  const _IntegralResult({
    required this.integral,
    required this.result,
  });
