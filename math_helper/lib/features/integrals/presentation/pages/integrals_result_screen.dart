...
class IntegralsResultScreen extends StatefulWidget {
  final Operation operation;
  const IntegralsResultScreen({super.key, required this.operation});

  @override
  State<IntegralsResultScreen> createState() => _IntegralsResultScreenState();
}

class _IntegralsResultScreenState extends State<IntegralsResultScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: IntegralSuccessWidget(
          title: widget.operation.title,
          integral: widget.operation.results[0],
