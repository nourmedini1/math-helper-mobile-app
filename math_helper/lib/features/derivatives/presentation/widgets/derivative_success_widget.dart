...
class DerivativeSuccessWidget extends StatelessWidget {
  final String title;
  final String expression;
  final String result;

  const DerivativeSuccessWidget({
    super.key,
    required this.title,
...
class _DerivativeResult extends StatelessWidget {
  final String expression;
  final String result;

  const _DerivativeResult({
    required this.expression,
    required this.result,
  });
